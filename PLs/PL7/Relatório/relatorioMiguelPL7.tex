...
\begin{document} 
	...
	Na interface do transdutor e o meio de propagação:
	
	\par O objetivo deste trabalho experimental é, portanto, utilizar estes conceitos-chave agora introduzidos para determinar as grandezas físicas referidas.
	...
	Registaram-se as alturas dos três cilindros de menor altura. Colocou-se cada um assente numa das suas faces circulares, ficando outra voltada pra cima - nessa, será feita o acoplamento com a sonda. Pondo uma gota de água nesta face (para melhor acoplamento), encostou-se o transdutor piezo-elétrico para se observar no \textit{MeasureUltraEcho}, modo \textit{A-scan} (no computador), um gráfico de sinais detetados em função do tempo. Guardaram-se os dados em ficheiros \textit{csv} com o objetivo de retirar as grandezas pretendidas. \\
	A interface transdutor-cilindro é mediada por água.\\
